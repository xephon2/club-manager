...
public class Address {
     ...
     * @param addressStreet street
     * @param addressHouseNumber house number
     * @param addressZipCode zip code
     * @param addressCity city
     */
    public Address(final String addressStreet,
            final int addressHouseNumber,
