...
public class Login extends JFrame {
	...
	/**
	 * Define an instance of the Messages object to display strings from
	 * messages.properties on the GUI.
	 */
	...
	private void initialize() {
		...
		gridBagConstraintsLogin.insets = new Insets(topInset, leftInset,
		...
		GridBagConstraints gridBagConstraintsUserNameMessage = new GridBagConstraints();
		gridBagConstraintsUserNameMessage.anchor = GridBagConstraints.EAST;
		gridBagConstraintsUserNameMessage.insets = new Insets(topInset,
				leftInset, bottomInset, rightInset);
		...
		userNameField.insets = new Insets(topInset, leftInset, bottomInset,
				rightInset);
		...
		JLabel passwordMessage = new JLabel(
				messages.getString("Messages.Password"));
		GridBagConstraints gridBagConstraintPasswordMessage = new GridBagConstraints();
		gridBagConstraintPasswordMessage.anchor = GridBagConstraints.EAST;
		gridBagConstraintPasswordMessage.insets = new Insets(topInset,
				leftInset, bottomInset, rightInset);
		...
		passwordField.insets = new Insets(topInset, leftInset, bottomInset,
				rightInset);
		...
		JButton btnOk = new JButton(messages.getString("Messages.OK"));
